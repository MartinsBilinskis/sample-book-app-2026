...
def test(String environment) {
    ...
    def directory = pwd()
    pwsh "echo '${directory}'"
    pwsh "docker run --rm --network sample-book-app-compose-network -v '${directory}'/test-reports/dev:/api-tests/mochawesome-report mtararujs/api-tests books BOOKS_${environment}"
